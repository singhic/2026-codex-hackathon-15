...
export default function Page() {
  return (
    <main className="min-h-svh bg-black px-4 py-5 text-white sm:px-8 sm:py-8">
      <div className="mx-auto flex min-h-[calc(100svh-2.5rem)] w-full max-w-5xl flex-col sm:min-h-[calc(100svh-4rem)]">
        <header className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-white/60">A/B Test Studio</p>
            </div>
          </div>
        </header>
        ...
        >
          <div className="max-w-3xl space-y-6">
            ...
            <Button
              size="lg"
              className="h-11 bg-white px-4 text-sm text-black hover:bg-white/90"
