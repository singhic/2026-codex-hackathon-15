...
export default async function OwnerResultsPage({ params }: ResultsPageProps) {
  ...
  return (
    <OwnerShell activeTab="tests">
      <section className="flex flex-1 flex-col px-5 pt-7">
        <h1 className="text-[26px] font-semibold">완료 리포트</h1>
        <p className="mt-1 text-sm text-[#adadb8]">
          고객이 선택한 포스터 결과를 확인하세요.
        </p>

        <article className="relative mt-8 h-[364px] rounded-[18px] border border-[#3d3d42] bg-[#1c1c1f] p-4">
        ...
        <button
          type="button"
          className="mt-5 flex h-12 items-center justify-center gap-2 rounded-[14px] bg-[#26262b] text-[15px] font-semibold transition-colors hover:bg-[#313138]"
        >
